...
export function FilmTable() {
  ...
  const handleShareClick = (film: Film) => {
  ...
  return (
    <>
                  ...
                  <TableCell>
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end" className="w-48">
                        ...
                        <DropdownMenuItem onClick={() => handleShareClick(film)}>Share Campaign</DropdownMenuItem>
                        <DropdownMenuSeparator />
      ...
      <ShareCampaignModal
        ...
        campaignTitle={selectedFilm?.title}
        campaignUrl={selectedFilm ? `${typeof window !== 'undefined' ? window.location.origin : ''}/creator/film/${selectedFilm.id}` : undefined}
      />
    </>
  )
}

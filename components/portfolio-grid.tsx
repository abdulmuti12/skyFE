...
export function PortfolioGrid() {
  ...
  const hasNoPortfolio = items.length === 0
    ...
    <section>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 lg:gap-6 mb-6 md:mb-8">
        ...
        <div className="bg-card border border-border rounded-lg p-4 md:p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl md:text-2xl lg:text-3xl font-bold">{hasNoPortfolio ? "–" : totalInvested}</p>
            </div>
        ...
        <div className="bg-card border border-border rounded-lg p-4 md:p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-muted-foreground text-sm md:text-base mb-2">Total Returns</p>
              <p className="text-xl md:text-2xl lg:text-3xl font-bold">{hasNoPortfolio ? "–" : totalInvestmentValue}</p>
            </div>
            <div className="text-muted-foreground text-lg md:text-xl">$</div>
          </div>
        </div>
      ...
      {hasNoPortfolio ? (
        <div className="flex items-center justify-center min-h-[400px] md:min-h-[500px]">
          <div className="text-center max-w-md px-4">
            <h2 className="text-xl md:text-2xl lg:text-3xl font-bold mb-3 md:mb-4">Your Portfolio is Empty</h2>
            <p className="text-sm md:text-base text-muted-foreground mb-6 md:mb-8 leading-relaxed">
              Invest in your favorite films to start building your creative portfolio and watch your assets grow.
            </p>
            <div className="flex justify-center">
              <Link href="/investor">
                <Button className="bg-[#FFE500] hover:bg-[#FFE500]/90 text-black font-semibold px-6 py-2 md:px-8 md:py-3 text-sm md:text-base">
                  Start Exploring
                </Button>
              </Link>
            </div>
